...
mealRoutes
  .route('/')
  .get(queryParamsHandler('meal'), mealController.getMeals)
...
mealRoutes
  ...
  .get(queryParamsHandler('mealIngredient'), mealController.getMealIngredients)
...
mealRoutes
  ...
  .get(queryParamsHandler('mealFeatures'), mealController.getMealFeatures)
